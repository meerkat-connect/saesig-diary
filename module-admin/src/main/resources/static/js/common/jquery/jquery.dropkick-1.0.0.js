...
(function ($, window, document) {
  ...
  var ie6 = false;
  var ieVersion = $.browser.version.split(".")[0]; // ie browser version 7 이상인지 체크
  ...
  var
    ...
    dropdownTemplate = [
      '<div class="dk_container" id="dk_container_{{ id }}" tabindex="{{ tabindex }}">',
        '<a class="dk_toggle" style="height:15px;overflow:hidden;">',
  ...
  methods.init = function (settings) {
    ...
    return this.each(function () {
      ...
      */
      ...
      /* crome browser close apply - 2013.09.30 - yhs */
      /*
      	$('body').click(function(){     		
