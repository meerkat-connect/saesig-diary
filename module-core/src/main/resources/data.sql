INSERT INTO member(id, email, password, prev_password, password_modified_at, signup_method, nickname, phone_number, status, last_logged_at, modified_at, modified_by, created_at, created_by, service_agreement, privacy_agreement)
...
VALUES (9, '관리자', '/admin', 'GET', 'Y', 'DIRECTORY', 1, 1, 0, NOW(), 1, NOW(), 1);

INSERT INTO resource(id, name, url, http_method, is_enabled, type, depth, ord, upper_id, modified_at, modified_by, created_at, created_by)
VALUES (1, '회원관리', '/admin/members', 'GET', 'Y', 'MENU', 2, 1, 9, NOW(), 1, NOW(), 1);

INSERT INTO resource(id, name, url, http_method, is_enabled, type, depth, ord, upper_id, modified_at, modified_by, created_at, created_by)
VALUES (2, '시스템관리', '/admin/system', 'GET', 'Y', 'MENU', 2, 2, 9, NOW(), 1, NOW(), 1);

INSERT INTO resource(id, name, url, http_method, is_enabled, type, depth, ord, upper_id, modified_at, modified_by, created_at, created_by)
VALUES (3, '시스템관리 목록화면', '/admin/system/view.html', 'GET', 'Y', 'MENU', 3, 1, 2, NOW(), 1, NOW(), 1);

INSERT INTO resource(id, name, url, http_method, is_enabled, type, depth, ord, upper_id, modified_at, modified_by, created_at, created_by)
VALUES (4, '시스템관리 등록', '/admin/system/**', 'POST', 'Y', 'FUNCTION', 4, 2, 3, NOW(), 1, NOW(), 1);

INSERT INTO resource(id, name, url, http_method, is_enabled, type, depth, ord, upper_id, modified_at, modified_by, created_at, created_by)
VALUES (5, '시스템관리 수정', '/admin/system/**', 'PUT', 'Y', 'FUNCTION', 4, 1, 3, NOW(), 1, NOW(), 1);

INSERT INTO resource(id, name, url, http_method, is_enabled, type, depth, ord, upper_id, modified_at, modified_by, created_at, created_by)
VALUES (6, '회원관리 목록화면', '/admin/members/view.html', 'GET', 'Y', 'FUNCTION', 3, 1, 1, NOW(), 1, NOW(), 1);

INSERT INTO resource(id, name, url, http_method, is_enabled, type, depth, ord, upper_id, modified_at, modified_by, created_at, created_by)
VALUES (7, 'DashBoard', '/admin', 'GET', 'Y', 'MENU', 2, 3, 9, NOW(), 1, NOW(), 1);

INSERT INTO resource(id, name, url, http_method, is_enabled, type, depth, ord, upper_id, modified_at, modified_by, created_at, created_by)
VALUES (8, 'Google Oauth', '/api/member/oauth2ClientCallback/google', 'GET', 'Y', 'MENU', 2, 4, 9, NOW(), 1, NOW(), 1);
